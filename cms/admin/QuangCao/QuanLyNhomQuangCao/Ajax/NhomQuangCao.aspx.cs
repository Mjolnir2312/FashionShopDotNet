...
public partial class cms_admin_QuangCao_QuanLyNhomQuangCao_Ajax_NhomQuangCao : System.Web.UI.Page
{
    ...
    private void XoaNhomQuangCao()
    {
        ...
        if (Request.Params["NhomQuangCaoID"] != null)
        {
            ...
            shopquanao.NhomQuangCao.Nhomquangcao_Delete(NhomQuangCaoID);
