...
public partial class cms_admin_QuangCao_QuanLyNhomQuangCao_NhomQuangCao_ThemMoi : System.Web.UI.UserControl
{
    ...
    private void HienThiThongTin(string id)
    {
        if (thaotac == "ChinhSua")
        {
            ...
            dt = shopquanao.NhomQuangCao.Thongtin_Nhomquangcao_by_id(id);
            if (dt.Rows.Count > 0)
            {
                ...
                ltrAnhDaiDien.Text = "<img class='anhDaiDien'src='/Picture/QuangCao/" + dt.Rows[0]["AnhDaiDienQC"] + @"'/>";
    ...
    protected void btThemMoi_Click(object sender, EventArgs e)
    {
        if (thaotac == "ThemMoi")
        {
            ...
            if (flAnhDaiDien.FileContent.Length > 0)
            {
                ...
                {
                    flAnhDaiDien.SaveAs(Server.MapPath("Picture/QuangCao/") + flAnhDaiDien.FileName);
                }
            }
            //else ltrThongBao.Text = "Nhập sai hoặc thiếu thông tin! Mời nhập lại";


            shopquanao.NhomQuangCao.Nhomquangcao_Insert(tbTenNhomQC.Text, tbViTriQC.Text, tbThuTu.Text, flAnhDaiDien.FileName, "");
        ...
        else
        {
            ...
            shopquanao.NhomQuangCao.Nhomquangcao_Update(id, tbTenNhomQC.Text, tbViTriQC.Text, tbThuTu.Text, flAnhDaiDien.FileName);
