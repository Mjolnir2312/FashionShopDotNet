...
public partial class cms_admin_QuangCao_QuanLyDanhSachQuangCao_DanhSachQuangCao_HienThi : System.Web.UI.UserControl
{
    ...
    private void LayQuangCao()
    {
        ...
        dt = shopquanao.QuangCao.Thongtin_Quangcao();
        ...
        <tr id='maDong_" + dt.Rows[i]["QuangCaoID"] + @"'>
               ...
               <td class='cotAnh'>
                 <img class='anhDaiDien'src='/Picture/QuangCao/" + dt.Rows[i]["AnhQC"] + @"'/>
                 <img class='anhDaiDienHover'src='/Picture/QuangCao/" + dt.Rows[i]["AnhQC"] + @"'/>
               </td>
