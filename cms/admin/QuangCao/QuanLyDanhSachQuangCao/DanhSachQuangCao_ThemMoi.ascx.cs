...
public partial class cms_admin_QuangCao_QuanLyDanhSachQuangCao_DanhSachQuangCao_ThemMoi : System.Web.UI.UserControl
{
    ...
    private void HienThiThongTin(string id)
    {
        if (thaotac == "ChinhSua")
        {
            ...
            dt = shopquanao.QuangCao.Thongtin_Quangcao_by_id(id);
            if (dt.Rows.Count > 0)
            {
                ...
                ltrAnhDaiDien.Text = "<img class='anhDaiDien'src='/Picture/QuangCao/" + dt.Rows[0]["AnhQC"] + @"'/>";
    ...
    {
        DataTable dt = new DataTable();
        dt = shopquanao.NhomQuangCao.Thongtin_Nhomquangcao();
    ...
    protected void btThemMoi_Click(object sender, EventArgs e)
    {
        if (thaotac == "ThemMoi")
        {
            ...
            shopquanao.QuangCao.Quangcao_Insert(
        ...
        else
        {
            ...
            shopquanao.QuangCao.Quangcao_Update(
