    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        switch (modulphu)
        {
            case "DanhSachQuangCao":
                plQuangCaoLoadControl.Controls.Add(LoadControl("QuanLyDanhSachQuangCao/QuanLyDanhSachQuangCaoLoadControl.ascx"));
                break;

            case "NhomQuangCao":
                plQuangCaoLoadControl.Controls.Add(LoadControl("QuanLyNhomQuangCao/QuanLyNhomQuangCaoLoadControl.ascx"));
                break;
